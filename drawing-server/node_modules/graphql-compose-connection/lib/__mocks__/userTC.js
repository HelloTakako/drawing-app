...
exports.sortOptions = exports.countResolver = exports.findManyResolver = exports.userList = exports.userTC = exports.UserType = void 0;
...
const findManyResolver = _graphqlCompose.schemaComposer.createResolver({
  ...
  args: {
    ...
    sort: new _graphql.GraphQLEnumType({
      name: 'SortUserInput',
      values: {
        ID_ASC: {
          value: {
